    ...
    <div className="priceList-section bg-gray-100 mx-auto py-24 text-gray-700">
      ...
      <div className="mt-12 flex justify-center">
        <h5
          ...
          } duration-500 hover:text-gray-800 text-lg cursor-pointer relative after:content-[''] after:bg-slate-400 after:h-[3px] after:left-0 after:-bottom-[1.5px] after:rounded-xl after:absolute after:duration-500 after:hover:w-full`}
        >
          Jawa
        </h5>
        <h5
          ...
          className={`${
            openTab === 2
              ? "after:w-full text-gray-800"
              : "after:w-0 text-gray-400"
          } duration-500 hover:text-gray-800 text-lg cursor-pointer relative after:content-[''] after:bg-slate-400 after:h-[3px] after:left-0 after:-bottom-[1.5px] after:rounded-xl after:absolute after:duration-500 after:hover:w-full ml-5`}
        >
          Sumatra
        </h5>
        <h5
      ...
      <div className="mt-6 text-center mx-72">
        <div className={openTab === 1 ? "block" : "hidden"}>
          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-4">
            <div className="group w-full inline-block cursor-pointer relative rounded-lg overflow-hidden row-span-2">
              <img
